package com.balogungift.project1.activity;
...
import com.balogungift.project1.R;
import com.balogungift.project1.bean.AttendanceBean;
import com.balogungift.project1.bean.AttendanceSessionBean;
import com.balogungift.project1.bean.FacultyBean;
import com.balogungift.project1.bean.StudentBean;
import com.balogungift.project1.context.ApplicationContext;
import com.balogungift.project1.db.DBAdapter;
...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	String branch = "ICT CENTER";
	String year = "2018/2019";
	String subject = "SC";

	private String[] branchString = new String[] { "ICT CENTER"};
	private String[] yearString = new String[] {"2018/2019"};
	...
	private String[] subjectFinal = new String[] {"Morning Devotion"};
